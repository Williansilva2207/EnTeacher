...
export default function HomePage() {
  const basicModules = [
    { id: 1, title: 'Basic 1', color: 'blue', icon: '📚', href: '/modules/basic1', completed: 'walking' },
    { id: 2, title: 'Basic 2', color: 'indigo', icon: '📖', href: '/modules/basic2', completed: 'no' },
    { id: 3, title: 'Intermediary 1', color: 'purple', icon: '🎓', href: '/modules/intermediary1', completed: 'no' },
  ];
